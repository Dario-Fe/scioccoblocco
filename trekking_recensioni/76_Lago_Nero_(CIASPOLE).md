...
periodo_consigliato: |
  da 
                              dicembre a marzo, (dipende dall'innevamento).
attrezzatura: |
  Ciaspole, bastoni, ghette, vestiti 
                            leggeri o sovrapposti a strati (cipolla) per la salita e ricambio, più giacca pesante nello zaino con cartina, pala, sonda, artva 
                            se l'avete, scorta di cibo e acqua.
tempo_di_percorrenza: |
  3.00h/3.30h salita e 
                            discesa di passo calmo e senza considerare le soste
dislivello: |
  Totale 708m(salita e discesa) --- Alpe 
                            Devero - Alpe Misanco +267m --- Alpe Misanco - Lago Nero +87m al riitorno gli stessi dislivelli di segno opposto.
strutture: |
  Alla piana del Devero si trovano diverse 
                            strutture sia per il semplice pasto che per il pernotto http://www.alpedevero.it/
come_raggiungere: |
  Da 
...
![](images_76/lagonero_scultura.jpg)
...
![](images_76/lagonero_noleggio.jpg)
...
![](images_76/lagonero_ponticello.jpg)
